...
MODEL_FLASH_3 = "gemini-3.1-flash-image"  # Nano Banana 2 (general, 4K)
MODEL_PRO = "gemini-3-pro-image"  # Nano Banana Pro (high quality, 4K)
...
class NanoBananaBase:
    ...
    def _build_generation_config(
        ...
        Args:
            ...
            image_size: e.g. "512", "1K", "2K", "4K" (Nano Banana 2 and Pro)
        ...
        if image_size and model in {"nano_banana_2", "nano_banana_pro"}:
